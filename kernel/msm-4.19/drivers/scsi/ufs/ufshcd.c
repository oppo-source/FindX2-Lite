...
#if defined(VENDOR_EDIT) && defined(CONFIG_UFSFEATURE)
/* Hank.liu@TECH.PLAT.Storage, 2019-10-31, add UFS+ hpb and tw driver*/
	dev_err(hba->dev,"UFS+DEBUG: %s;line :%d\n", __func__, __LINE__);
...
#ifdef VENDOR_EDIT
		//yujinghua@TCHP, add for ufs debug
		dev_err(hba->dev,"UFS+DEBUG: %s; line :%d\n", __func__, __LINE__);
#endif /* VENDOR_EDIT */
		goto enable_gating;
	}
...
#ifdef VENDOR_EDIT
		//yujinghua@TCHP, add for ufs debug
		dev_err(hba->dev,"UFS+DEBUG: %s UFS_ERR_SUSPEND ; line :%d\n", __func__, __LINE__);
#endif /* VENDOR_EDIT */
...
#ifdef VENDOR_EDIT
	//yujinghua@TCHP, add for ufs debug
	dev_err(hba->dev,"UFS+DEBUG: %s begin;line :%d\n", __func__, __LINE__);
#endif
...
//cuixiaogang@SRC.hypnus. 2018.09.13. add for ufs debug
	...
	dev_err(hba->dev,"UFS+DEBUG: %s end; line: %d ret: %d\n", __func__, __LINE__, ret);
#endif /* VENDOR_EDIT */
	return ret;
}
